        ...
        <>
            <header className="bg-header-green flex justify-between w-full h-12 p-2 items-center gap-12">
                ...
                <div className="flex gap-6 items-center">
                    <Link className={`font-sans w-14`} href={"/login"}>Log in</Link>
                    <button className={`w-24 bg-button-green rounded p-2 text-slate-100`}><span className={`font-sans`}>Sign up</span></button>
                </div>
            </header>
